...
population = run_simulation(11, one_of_each_state, 30)
population
```
    ...
    ##  4          4 infe… infe… infe… infe… infe… symp… symp… symp… symp… sympt…
    ##  5          5 infe… symp… symp… symp… symp… symp… dont… dont… dont… dont_…
    ##  6          6 symp… symp… symp… symp… symp… dont… dont… dont… dont… dont_…
    ##  7          7 symp… symp… symp… symp… reco… reco… reco… reco… reco… recov…
    ##  8          8 get_… get_… get_… get_… get_… get_… get_… get_… get_… get_h…
    ##  9          9 dont… dont… dont… dont… dont… dont… dont… dont… dont… dont_…
    ## 10         10 reco… reco… reco… reco… reco… reco… reco… reco… reco… recov…
    ## 11         11 dead  dead  dead  dead  dead  dead  dead  dead  dead  dead  
...
```
    ...
    ##  3     1 get_hospital_care                       1
    ##  4     1 infected_asymptomatic                   1
    ##  5     1 infected_symptomatic_pre_symptoms       1
    ##  6     1 infectious_asymptomatic                 1
    ##  7     1 infectious_symptomatic_pre_symptoms     1
    ##  8     1 recovered                               1
    ##  9     1 succeptible                             1
    ## 10     1 symptomatic_dont_need_hospital          1
    ## # … with 142 more rows
